...
export const TESTIMONIALS = [
  {
    quote:
      "With Splitzy, I never have to worry about forgotten payments or chasing friends. It's simple, smart, and effective",
    name: "John",
  ...
  {
    quote:
      "I used to dread settling up after trips, but Splitzy keeps everything crystal clear. Total game-changer! love it",
    name: "Rahul",
  ...
  {
    quote:
      "Splitzy made group expenses so much easier to manage. No more awkward money talks, highly recommend!",
    name: "Piyush",
